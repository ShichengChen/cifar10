...
class Options():
    def __init__(self):
        ...
        # model params
        parser.add_argument('--model', type=str, default='encnetdrop',
            help='network model type (default: densenet)')
        parser.add_argument('--nclass', type=int, default=10, metavar='N',
            help='number of classes (default: 10)')
        parser.add_argument('--widen', type=int, default=8, metavar='N',
        ...
        parser.add_argument('--checkname', type=str, default='mycheckpoint',
